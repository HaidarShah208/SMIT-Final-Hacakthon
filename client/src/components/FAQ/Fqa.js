            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col-12 col-md-12 col-lg-6">
                        ...
                        <div className="row">
                            <div className="col">
                               <Link to='/contact'> <button type="button" className="btn btn-primary text-white rounded-pill px-5 button1 my-5"> CONTACT US TODAY <i className="fa-solid fa-arrow-right ms-2 "></i></button></Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-12 col-lg-6">
