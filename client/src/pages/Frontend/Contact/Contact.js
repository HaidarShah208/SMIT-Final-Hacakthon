      ...
      <div className="treatment">
        ...
        <div className="container">
          <div className="row justify-content-center">
           ...
           <p>Vist to this city</p>
                <p className='text-primary nav-link'>Faislabad</p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-4">
              <div className="card p-4 mb-4">
                ...
                <p className='text-primary nav-link'><a href="mailto:haider753841@gmail.com">753841@gmail.com <br /> </a></p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-4">
              <div className="card p-4 mb-4">
                ...
                <p className='text-primary nav-link'>(+92) 310-7580073</p>
              </div>
            </div>
